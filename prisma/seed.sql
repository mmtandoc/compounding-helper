...
INSERT INTO "public"."risk_assessments" ("id", "compoundName", "complexity", "preparationFrequency", "isPreparedOccasionally", "isSmallQuantity", "averagePreparationAmountQuantity", "averagePreparationAmountUnit", "isConcentrationHealthRisk", "requireSpecialEducation", "hasVerificationSteps", "haveAppropriateFacilities", "requireVentilation", "isWorkflowUninterrupted", "workflowStandardsProcess", "microbialContaminationRisk", "crossContaminationRisk", "sdsSkinExposureRisk", "sdsEyeExposureRisk", "sdsInhalationExposureRisk", "sdsOralExposureRisk", "sdsOtherExposureRisk", "sdsOtherExposureRiskDescription", "pmSkinExposureRisk", "pmEyeExposureRisk", "pmInhalationExposureRisk", "pmOralExposureRisk", "pmOtherExposureRisk", "pmOtherExposureRiskDescription", "ppeGlovesRequired", "ppeGlovesType", "ppeCoatRequired", "ppeCoatType", "ppeMaskRequired", "ppeMaskType", "ppeEyeProtectionRequired", "ppeOther", "requireEyeWashStation", "requireSafetyShower", "riskLevel", "automaticRationale", "additionalRationale", "dateAssessed", "updatedAt") VALUES (4, '1% HC POWDER IN CLOTRIMADERM', 'Simple', 'monthly', true, true, 50, 'g', false, false, false, true, true, true, NULL, true, false, false, true, false, false, false, NULL, false, false, false, false, false, NULL, true, 'regular', true, 'designated', false, NULL, false, '', false, false, 'A', '{"Non-NIOSH ingredients.","Low frequency.","Small quantity is being used (50 g)","Low concentration.","Have appropriate facilities.","Compounding complexity is simple.","Safety risks to compounding staff minimized by PPE: Coat (designated), Gloves (regular)"}', '{"VENTILATION NOT NEEDED DUE TO THE ABOVE ASSESSMENT RATIONALE","EYE PROTECTION NOT NEEDED SINCE ONLY CATEGORY 2B","MINIMIZED RISK DUE TO USE OF COMMERICAL CREAM"}', '2022-09-03', '2022-09-04 16:46:24.376');
...
INSERT INTO "public"."ingredients" ("id", "riskAssessmentId", "safetyDataSheetId", "physicalForm", "commercialProductName", "commercialProductDin", "hasProductMonographConcerns", "concernsDescription") VALUES (2, 2, 1, 'cream', 'TEST COMMERICAL PRODUCT', 123456, true, 'TEST PRODUCT MONOGRAPH CONCERNS');
INSERT INTO "public"."ingredients" ("id", "riskAssessmentId", "safetyDataSheetId", "physicalForm", "commercialProductName", "commercialProductDin", "hasProductMonographConcerns", "concernsDescription") VALUES (3, 3, 1, 'cream', 'TEST COMMERICAL PRODUCT', 123456, true, 'TEST PRODUCT MONOGRAPH CONCERNS');
...
SELECT pg_catalog.setval('public.chemicals_id_seq', 6, true);
...
SELECT pg_catalog.setval('public.hazard_category_to_sds_id_seq', 29, true);
...
SELECT pg_catalog.setval('public.risk_assessments_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.safety_data_sheets_id_seq', 8, true);
